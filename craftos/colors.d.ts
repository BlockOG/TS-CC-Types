...
/**
 * Constants and functions for color values, suitable for working with {@link term} and {@link redstone}.
 *
 * This is useful in conjunction with {@link redstone.setBundledOutput Bundled Cables} from mods like Project Red, and
 * {@link term.setTextColor colors on Advanced Computers and Advanced Monitors}.
 *
 * For the non-American English version just replace {@link colors} with {@link colours}. This alternative API is exactly
 * the same, except the colours use British English (e.g. {@link colors.gray} is spelt {@link colours.grey}).
 *
 ...
 * supports color by using the function {@link term.isColor}.
 *
...
declare namespace colors {
    /** White: Written as `0` in paint files and {@link term.blit}, has a default terminal color of #F0F0F0. */
    const white: number;
    /** Orange: Written as `1` in paint files and {@link term.blit}, has a default terminal color of #F2B233. */
    const orange: number;
    /** Magenta: Written as `2` in paint files and {@link term.blit}, has a default terminal color of #E57FD8. */
    const magenta: number;
    /** Light Blue: Written as `3` in paint files and {@link term.blit}, has a default terminal color of #99B2F2. */
    const lightBlue: number;
    /** Yellow: Written as `4` in paint files and {@link term.blit}, has a default terminal color of #DEDE6C. */
    const yellow: number;
    /** Lime: Written as `5` in paint files and {@link term.blit}, has a default terminal color of #7FCC19. */
    const lime: number;
    /** Pink: Written as `6` in paint files and {@link term.blit}, has a default terminal color of #F2B2CC. */
    const pink: number;
    /** Gray: Written as `7` in paint files and {@link term.blit}, has a default terminal color of #4C4C4C. */
    const gray: number;
    /** Light Gray: Written as `8` in paint files and {@link term.blit}, has a default terminal color of #999999. */
    const lightGray: number;
    /** Cyan: Written as `9` in paint files and {@link term.blit}, has a default terminal color of #4C99B2. */
    const cyan: number;
    /** Purple: Written as `a` in paint files and {@link term.blit}, has a default terminal color of #B266E5. */
    const purple: number;
    /** Blue: Written as `b` in paint files and {@link term.blit}, has a default terminal color of #3366CC. */
    const blue: number;
    /** Brown: Written as `c` in paint files and {@link term.blit}, has a default terminal color of #7F664C. */
    const brown: number;
    /** Green: Written as `d` in paint files and {@link term.blit}, has a default terminal color of #57A64E. */
    const green: number;
    /** Red: Written as `e` in paint files and {@link term.blit}, has a default terminal color of #CC4C4C. */
    const red: number;
    /** Black: Written as `f` in paint files and {@link term.blit}, has a default terminal color of #111111. */
    const black: number;
     ...
     *     // => 0xb23399
     *
     * @param r The red channel, as an argument to {@link colors.packRGB} or the combined hexadecimal color, as an
     *   argument to {@link colors.unpackRGB}.
     ...
     * @returns The combined hexadecimal color, as returned by {@link colors.packRGB} or the red channel, as returned by
     *   {@link colors.unpackRGB}.
